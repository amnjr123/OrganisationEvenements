...
public class CAccueil {
	...
	public Organisateur afficherInterfaceOrganisateur(char nature, JFrame frame) {
		boolean exist = false;
	...
	public GestionnaireOrganisme afficherInterfaceGestionnaireOrganisme(char nature,JFrame frame) {
		boolean exist = false;
